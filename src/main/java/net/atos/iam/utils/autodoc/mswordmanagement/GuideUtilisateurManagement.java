...
@Component
public class GuideUtilisateurManagement extends AutoDocUtils{

	public void generateDocument(String titreDocument, String referenceJira, String chefProjetSI) throws FileNotFoundException, IOException, URISyntaxException {

		String formattedDate = (new SimpleDateFormat("yyyy-MM-dd")).format(new Date());

		String resourcePath = "template\\guideUtilisateur.docx";
		...
		this.saveDocument("C:\\tmp\\TMA_GRC_" + DocumentTypes.GUIDE_UTILISATEUR.getSigle()
				+ "_" + referenceJira + "_" + titreDocument + "_V1.0" 
				+ ".docx", doc);
	}
