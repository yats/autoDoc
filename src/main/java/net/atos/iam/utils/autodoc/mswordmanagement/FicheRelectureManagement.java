...
@Component
public class FicheRelectureManagement extends AutoDocUtils{

	public void generateDocument(String titreDocument, String referenceJira) throws FileNotFoundException, IOException, URISyntaxException {

		String formattedDate = (new SimpleDateFormat("yyyy-MM-dd")).format(new Date());

		String resourcePath = "template\\ficheRelecture.docx";
		...
		this.saveDocument("C:\\tmp\\TMA_GRC_" + DocumentTypes.FICHE_RELECTURE.getSigle()
