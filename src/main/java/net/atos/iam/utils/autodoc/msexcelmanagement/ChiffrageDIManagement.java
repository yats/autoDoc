...
public class ChiffrageDIManagement extends AutoDocUtils{
	...
	public void generateDocument(String titreDocument, String referenceJira,String description) throws Exception {
		...
		doc.save("C:\\tmp\\TMA_GRC_" + DocumentTypes.CHIFFRAGE_DI.getSigle()+ "_" + referenceJira + "_" + titreDocument + "_V_1.0.xlsx");
	}
