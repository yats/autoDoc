...
@Component
public class MacroChiffrageManagement extends AutoDocUtils{

	public void generateDocument(String titreDocument, String referenceJira,String description) throws Exception {

		String resourcePath = "template\\macroChiffrage.xlsx";
		...
		doc.save("C:\\tmp\\TMA_GRC_" + DocumentTypes.MACRO_CHIFFRAGE.getSigle()+ "_" + referenceJira + "_" + titreDocument + "_V_1.0.xlsx");
	}
