...
import net.atos.iam.utils.autodoc.msexcelmanagement.ChiffrageDIManagement;
import net.atos.iam.utils.autodoc.mswordmanagement.constantes.DocumentConstantes;

public class ChiffrageDIPanel extends Panel implements GrcAutoDocPanel {
	...
	public void init(Window window,Screen screen) {
        ...
        Label label = new Label("Chiffrage DI");
	...
	public void generateDocuments() {
		try {
			ChiffrageDIManagement docManagement = new ChiffrageDIManagement();
