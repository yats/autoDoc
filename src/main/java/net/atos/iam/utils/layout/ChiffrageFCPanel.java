...
import net.atos.iam.utils.autodoc.msexcelmanagement.ChiffrageFCManagement;
import net.atos.iam.utils.autodoc.mswordmanagement.constantes.DocumentConstantes;

public class ChiffrageFCPanel extends Panel implements GrcAutoDocPanel {
	...
	public void init(Window window,Screen screen) {
        ...
        Label label = new Label("Chiffrage FC");
	...
	public void generateDocuments() {
		try {
			ChiffrageFCManagement docManagement = new ChiffrageFCManagement();
